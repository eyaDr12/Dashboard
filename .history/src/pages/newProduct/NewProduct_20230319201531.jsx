  ...
  return (
    ...
    <div className="newProduct">
      <form className="addProductForm">
        ...
        <div>
        <div className="addProductItem">
          <input type="text" className="form-control3" placeholder=" Product Name" />
        </div>
        <div className="addProductItem">     
        <input type="text"  className="form-control3" placeholder="Stock"/>
        </div>
        <div className="addProductItem">
          <input type="text"  className="form-control3" placeholder="Categories"/>
        </div>
        </div>
        <div>
        <div className="addProductItem">
