    ...
    <div className="login-form-container">
      ...
      <h1 className="h3_login">Login</h1><br/><br/>
        ...
        <div className="login_icons">
          <button  className="btn__icon"><FcGoogle className="google_icon" /> <span  style={{marginLeft:'4px',fontSize:'13px',}}>Google</span></button>
          <button className="btn__icon"><BsFacebook className="facebook_icon" /><span  style={{marginLeft:'4px',fontSize:'13px',}}>Facebook</span></button>
        </div>
