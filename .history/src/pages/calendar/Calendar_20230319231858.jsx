...
<Calendar localizer={localizer} events={allEvents} startAccessor="start" endAccessor="end" style={{ height: 500, margin: "30px",marginLeft:'-20px',width:'100%',marginTop:'5px' }} />
