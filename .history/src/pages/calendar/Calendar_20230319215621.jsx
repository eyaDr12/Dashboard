 ...
 <h2>Add New Event</h2>
            ...
            <center>
              <div style={{display:'flex'}}>
                ...
                <input type="text" placeholder="Add Title" style={{ width: "20%", marginRight: "10px" }} value={newEvent.title} onChange={(e) => setNewEvent({ ...newEvent, title: e.target.value })} className />
