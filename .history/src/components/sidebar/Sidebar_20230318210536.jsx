      ...
      <ul className="sidebar-menu">
       ...
       <Link to='/ProductList'><MdOutlineStorefront/><span >Products</span>
        ...
        {showDrop && (
          ...
          <li>
            <Link to='/bills'><CgLoadbarDoc /><span >Bills</span></Link> 
          </li>
          </ul>

        )}
      < li>
      <Link to='/taxes'><HiOutlineDocumentText/><span >Taxes</span></Link>
      </li>
      <li>
      <Link to='/Calendar'><MdMailOutline/><span >Calendar</span></Link> 
      </li>
       <li><Link to='/Messages'><MdChatBubbleOutline/><span >Messages</span></Link> 
       </li>
      </ul>
    </div>
  );
