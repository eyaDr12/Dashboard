  ...
  return (
    <div className="sidebar">
      ...
      <ul className="sidebar-menu">
       ...
       <Link ><li onClick={toggleDropdown1}> <FiUsers /><span style={{marginLeft:'6px'}}>Employees</span> <RiArrowDownSFill/></Link></li>
        {showDropdown && (
       ...
       <Link to='/ProductList'><MdOutlineStorefront/><span style={{marginLeft:'6px'}}>Products</span>
        ...
        <Link to='/Orders'><MdAttachMoney/><span style={{marginLeft:'6px'}}>Orders</span></Link> 
            ...
            <li onClick={toggleDropdown2}><CgLoadbarDoc /><span style={{marginLeft:'6px'}}>Documents </span><RiArrowDownSFill/></li>
        {showDrop && (
          <ul className="dropdown-menu">
           <li>
