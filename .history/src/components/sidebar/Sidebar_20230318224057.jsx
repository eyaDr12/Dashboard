...
function Sidebar() {
  ...
  const [clicked2, setClicked1] = useState(false);
  ...
  return (
    ...
    <div className="topLeft">
      ...
      <ul className="sidebar-menu">
       ...
       <span style={{marginLeft:'42px'}}>{ clicked ? <RiArrowUpSFill  /> :<RiArrowDownSFill  />}</span>
            </Link></li>
        {showDropdown && (
       ...
       <Link to='/ProductList'><MdOutlineStorefront/><span style={{marginLeft:'6px'}}>Products</span>
        ...
        <Link to='/Orders'><MdAttachMoney/><span style={{marginLeft:'6px'}}>Orders</span></Link> 
            ...
            <li onClick={toggleDropdown2}> <Link ><CgLoadbarDoc /><span style={{marginLeft:'6px'}}>Documents </span>     
             <span style={{marginLeft:'35px'}}>{ clicked ? <RiArrowUpSFill  /> :<RiArrowDownSFill  />}</span></Link >
              </li>
        {showDrop && (
          <ul className="dropdown-menu">
           <li>
