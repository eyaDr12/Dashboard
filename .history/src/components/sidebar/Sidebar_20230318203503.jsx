...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
      ...
      <ul className="sidebar-menu">
       ...
       <Link to='/ProductList'><MdOutlineStorefront/>Products
        ...
        {showDrop && (
          <ul className="dropdown-menu">
           <li>
           <Link to='/documents/P'><CgLoadbarDoc />purchase order</Link> 
           </li>
          <li>
      ...
      < li>
      <Link to='/'><HiOutlineDocumentText/>Taxes</Link>
      </li>
      <li>
      <Link to='/'><MdMailOutline/>Calendar</Link> 
      </li>
       <li><Link to='/'><MdChatBubbleOutline/>Messages</Link> 
       </li>
      </ul>
    </div>
  );
